---
title: >-
  Auto-response is restricted to an allowlist of categories answered from
  structured data, not LLM generation
description: >-
  The LLM classifies the question but the answer comes from a versioned data
  field lookup -- never safety, health, financial, legal, or HR topics
