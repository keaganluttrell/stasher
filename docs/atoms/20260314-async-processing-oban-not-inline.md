---
title: >-
  AutoProxy processes messages asynchronously via Oban, never blocking message
  delivery
description: >-
  Oban provides retries, observability, rate limiting, and ordering guarantees
  that inline GenServer processing cannot
