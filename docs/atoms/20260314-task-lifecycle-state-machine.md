---
title: >-
  Hospitality tasks need a state machine with inspection and
  maintenance-specific states
description: >-
  Task lifecycle design for hospitality must support created through verified
  plus maintenance holds and escalation
