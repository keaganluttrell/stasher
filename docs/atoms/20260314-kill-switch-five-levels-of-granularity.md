---
title: >-
  Kill switches operate at five granularity levels with asymmetric activation
  and restoration
description: >-
  Global, per-capability, per-property, per-channel, and per-user kill switches
  take effect in 30 seconds; rollback requires no approval
