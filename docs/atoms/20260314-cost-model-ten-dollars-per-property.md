---
title: >-
  AutoProxy costs approximately $10 per month per property at 100 messages per
  day
description: >-
  Classification is effectively free via Haiku; response generation via Sonnet
  on 20% of messages is the dominant cost
